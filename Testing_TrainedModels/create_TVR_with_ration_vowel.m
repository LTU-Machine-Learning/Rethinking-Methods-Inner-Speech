function [train_data,train_labels,val_data,val_labels,test_data,test_labels]=create_TVR_with_ration_vowel(seed_value,vowel_data,ratio,vowels_list)
rng(seed_value);

for tt=1:length(vowels_list)
      kk=vowel_data.(vowels_list(tt));
