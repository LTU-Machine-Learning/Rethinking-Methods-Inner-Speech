...
%base_path='Location for processed vowel data';
cl='words'; %  for words
num_trails=5;
...
numOfClasses=length(words_list);
...
for j=1:15 % number of subjects
  ...
  % Running program for five random trails
      for trails=1:num_trails
          ...
          [train_data,train_lables,val_data,val_lables,test_data,test_lables]=create_TVR_with_ration_words(seed_value(trails),word_data,ratio,words_list);
